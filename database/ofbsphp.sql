...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2025 at 04:37 PM
...
(1, 'Annan', 'annan@mail.com', '$2a$12$ZV/4mPR9hsjz9kafDlXOGeS9fbSloW2U.JCSdV9MFIx.rUWJ1d86i');
...
(1, 'mohammadzohair41@gmail.com', 'zxjcgvBSc ', 'Social Media', '', 2);
...
(20, 1, '2022-07-05 23:58:00', '2022-07-05 22:14:00', 'Zhotrora', 'Trerdence', 'Aero Airways', '208', '1', 0, 'dep', '', '21B', 20, ''),
(23, 1, '2025-06-13 06:30:00', '2025-06-12 06:30:00', 'Chicago', 'San', 'PAKAIRLINE1', '21', '12', 1200, '', '', '', 20, '');
...
(1, 'mohammadzohair41@gmail.com', '4a9ad923185fc138', '$2y$10$RyKEaiKa.natqJmXgegtKuctzvnYmN8c5CITZMMNYgs36Ucejwz6u', '1749651660');
...
(3, '', '', ''),
(4, '', '', ''),
(5, 'Muhammad Zohair', 'mohammadzohair41@gmail.com', '$2y$10$nD1atoVs1t2Ud4dZs/77uOlptFmYZ.Cvma6VzmOX8vMJIJnwe5fve');
...
--
ALTER TABLE `airline`
  MODIFY `airline_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
